        ...
        <div id="content">
            <div class="container">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box">
                        <h1>MOGPlay</h1>
                        <p>MOGPlay adalah voucher pengisian saldo yang dapat digunakan untuk membeli game-game dari ZingPlay Indonesia, Winner Interactive, Efun, Qeon, Wayang Force, Orangegame, Digiecash, Viwawa, MainGame/Mp Game, True Digital Plus, Perfect game, Soaindo, Stardoll, Gamebatte, Idweb game, Idgameland, RH Siamgames, Boyaa, Garena, MusikLegal, Cubizone, MOGPLAY, Melon, Kubikgames, IGG, KlikMusik, Joyspade, Indoplay, Goodgames, Cyberstep, Agatte, Cherry Credits, Gumi, Go Play, Onsof, Paramidatech, GameView, Garuda Point, Gameloe, R2 Games, Mobvista, Gamespark, Bluepay, dan Valofe</p>

                        <strong>Daftar Game</strong>
                        <p>Poker Texas, Hero Dream, Capsa Susun, X-Shot 2.0, Tank Storm, Clash of Gods, Wayang Force, Crystal Saga, Crystal Epic 2, Kingdom Fighter Indonesia, Aerena, Battle Station, Baby Saga, Rise of The Dragon, etc.</p>
                    </div>
