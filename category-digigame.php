            ...
            <div class="container">
                ...
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>Digi Game Card</li>
                    </ul>

                    <div class="box">
                        <h1>Digi Game Card</h1>
                        <p>Digi Game Card adalah Voucher Digi Game Card dapat digunakan untuk mengisi saldo game-game dari publisher Prodigy dan Perfectgame, seperti Touch, Pirate King, World Of Avatar, dan lain-lain.</p>

                        <strong>Daftar Game</strong>
                        <p>Baby Saga, Swordsman, Unison League, Touch, Pirate King, World Of Avatar, dan lain-lain.</p>
                    </div>
