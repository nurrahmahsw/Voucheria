        ...
        <div id="content">
            <div class="container">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box">
                        <h1>Travian</h1>
                        <p>Travian adalah permainan berbasis web yang dikembangkan oleh Travian Games GmbH Jerman yang sebagian besar berhubungan dengan permainan pendahulunya yang disebut Tribal Wars. Pada tahun 2006, permainan ini mendapat peringkat satu dalam "permainan browser-based terbaik dengan lebih dari 10.000 pemain". Saat ini Travian dimainkan Jutaan Player di seluruh dunia dan telah di rilis dalam berbagai versi bahasa. Dalam game ini, pemain dapat memilih salah satu dari tiga suku, suku tersebut yaitu: Romawi, Galia dan Teuton. Para pemain memulai dari sebuah desa kecil yang hanya memiliki 2 populasi. Pada tahap selanjutnya player akan di tuntut untuk membangun kekuatan militer yang kuat untuk menyerang dan bertahan.</p>
                        <strong>Daftar Game</strong>
                        <p>Travian Legend, Crowfall, Travian Kingdoms, Rail Nation, Goalunited LEGENDS, Miramagia, United GP dan lain-lain.</p>
                    </div>
