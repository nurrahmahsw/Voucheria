            ...
            <div class="container">
                ...
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>Xbox Live Gift Card (US)</li>
                    </ul>

                    <div class="box">
                        <h1>Xbox Live Gift Card (US)</h1>
                        <p>Xbox Live Gift Card (Xbox Card) merupakan voucher prabayar untuk pengisian saldo akun Xbox Live kamu yang kemudian bisa digunakan untuk membeli game-game di Xbox Store. Selain itu kamu bisa menonton TV dari SKY, Netflix, BBC iPlayer dan YouTube.</p>
                        <strong>Daftar Game</strong>
                        <p>Forza Horizon, Gears of War, Neverwinter, Halo, FIFA 15, FIFA 16, FIFA 17, Gears of War, Battlefield 1, Dishonored 2, Watch Dog 2, Titanfall 2, Forza Horizon 3, Madden NFL dan lain-lain.</p>
                    </div>
